...
ATTACHMENT.Name = "ZRX Flashlight"
ATTACHMENT.Model = Model("models/more/flashlight/zrx/zrx_lighht.mdl")
ATTACHMENT.Icon = Material("more_s_icons/wmx200.vmt")
ATTACHMENT.BonemergeToCategory = {"Barrels"}
 
ATTACHMENT.VElement = {
                 Bone = "tag_barrel_attach",
                 Position = Vector(-0.1, 10, 1.9),
                 Angles = Angle(0, 0, 0),
                 Offsets = { 
                 }
             }
