...
SWEP.PrintName = "AR-47 Custom"
SWEP.Category = "Modern Warfare"
SWEP.SubCategory = "Assault Rifles"
SWEP.Spawnable = true
SWEP.VModel = Model("models/zeron/v_ar47.mdl")
...
SWEP.Recoil = {
    Vertical = {1, 2.2}, --random value between the 2
    ...
    Seed = 1212312121, --give this a random number until you like the current recoil pattern
    ViewModelMultiplier = 1.23,
	AdsShakeMultiplier = 1.25,
	Punch = 0.5
}
SWEP.Bullet = {
    Damage = {32, 17}, --first value is damage at 0 meters from impact, second value is damage at furthest point in effective range
